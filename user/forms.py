...
class RegForm(forms.Form):
    ...
    username = forms.CharField(
        label="用户名",min_length=3,max_length=10,widget=forms.TextInput(
    ...
    verification_code = forms.CharField(
        label="验证码",
        required=False,
        max_length=4,widget=forms.TextInput(
            attrs={'class':'form-control','placeholder':'点击发送“验证码”到邮箱'}))
    password = forms.CharField(label="密码",min_length=3,max_length=16,widget=forms.PasswordInput(
        attrs={'class':'form-control','placeholder':'请输入密码'}))
    password_again = forms.CharField(label="再输入一次密码",min_length=3,max_length=16,widget=forms.PasswordInput(
...
class ChangNicknameForm(forms.Form):
    nickname_new = forms.CharField(label="新昵称",max_length=20,widget=forms.TextInput(attrs={'class':'form-control','placeholder':'请输入新的昵称'}))
...
class ChangePasswordForm(forms.Form):
    ...
    new_password_again = forms.CharField(
        label="确认新的密码",widget=forms.PasswordInput(
